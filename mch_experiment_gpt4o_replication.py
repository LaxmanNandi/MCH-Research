...
class MCHExperiment:
    ...
    def run_experiment(self, prompts: List[str]) -> Dict:
        print("\n" + "="*60)
        print("MCH v8.1 REPLICATION EXPERIMENT - GPT-4o-mini Only")
        print("="*60)
...
def main():
    ...
    config = ExperimentConfig(
        participant_id="gpt4o_mini_replication",
        n_trials=30,
    ...
    experiment.save_results("mch_results_gpt4o_mini_replication.json")
