...
class ExperimentConfig:
    participant_id: str = "claude_opus_100trials"
    n_trials: int = 100
    ...
    def __post_init__(self):
        if self.models_to_test is None:
            self.models_to_test = ["claude-opus-4-5-20251101"]
...
class MCHExperimentClaudeOpus:
    def __init__(self, config: ExperimentConfig):
        ...
        print("Claude Opus 4.5 client configured!")
    ...
    def generate_with_claude(self, prompt: str, context: List[str], trial_num: int, condition: str) -> str:
        ...
        for attempt in range(self.config.max_retries):
            ...
            try:
                # Use Claude Opus 4.5 with higher max_tokens (Opus generates longer responses)
    ...
    def run_experiment(self, prompts: List[str]) -> Dict:
        print("\n" + "="*60)
        print("MCH v8.1 EXPERIMENT - Claude Opus 4.5 (Flagship)")
        print("="*60)
...
def main():
    # Same sequential prompts as all other experiments
    sequential_prompts = [
    ...
    config = ExperimentConfig(
        participant_id="claude_opus_100trials",
        n_trials=100,
        models_to_test=["claude-opus-4-5-20251101"],
    ...
    experiment = MCHExperimentClaudeOpus(config)
    results = experiment.run_experiment(sequential_prompts)
    experiment.save_results("mch_results_claude_opus_100trials.json")

    print("\n" + "="*60)
    print("CLAUDE OPUS 4.5 EXPERIMENT COMPLETE (100 TRIALS)")
    print("="*60)
