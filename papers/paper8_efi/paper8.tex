...
\hypersetup{
    ...
    citecolor=blue,
    urlcolor=blue,
    pdftitle={Encoding Fidelity and Coherent Misalignment in Non-English Clinical AI},
    pdfauthor={Laxman M M},
}

% ================================================================
\title{\LARGE\textbf{Encoding Fidelity and Coherent Misalignment\\
in Non-English Clinical AI}}
...
\textbf{Translation fidelity} (cosine similarity of LLM translation to reference English, Table~\ref{tab:translation}):
...
\textbf{Response centroid similarity} (Table~\ref{tab:fidelity}):
...
The experimental design is summarised in Table~\ref{tab:scale}. We constructed a battery of 15 clinical sentences at three complexity levels, each in four languages (English, Kannada, Tamil, Hindi):
...
This research received no external funding. All experiments were conducted using publicly available LLM APIs at the author's personal expense.

% ================================================================
\section*{Acknowledgements}

The clinical perspective in this paper comes from practice in resource-constrained primary health settings where AI-assisted care is increasingly deployed but where patients present in local languages. These observations apply wherever AI-assisted healthcare meets non-English speaking populations. AI systems (Claude, ChatGPT, DeepSeek) assisted with data analysis, visualisation, and manuscript preparation. The framework, findings, and interpretations remain the author's sole responsibility.

% ================================================================
\section*{Data Availability}

All experimental data, analysis scripts, and raw LLM responses are available at \url{https://doi.org/10.5281/zenodo.19371897} (Zenodo, DOI: 10.5281/zenodo.19371897). The repository is also available at \url{https://github.com/LaxmanNandi/MCH-Research}. OSF pre-registration: \url{https://osf.io/dp8nj/} (March 2026).

% ================================================================
\section*{Ethics Statement}

This study did not involve human participants, patient data, or electronic health records. All experiments were conducted on a purpose-built battery of constructed clinical sentences. No identifiable patient information was collected or used at any stage. Institutional review board (IRB) approval and informed consent were not required.

% ================================================================
\section*{Author Contributions}
L.M.M. conceived the study, designed the experimental framework, collected all data, performed all analyses, and wrote the manuscript in its entirety. AI systems (Claude, ChatGPT, DeepSeek) assisted with data analysis, visualisation, and manuscript preparation under the sole direction and responsibility of the author.
...
All analysis scripts, experimental pipelines, and replication code are available at \url{https://doi.org/10.5281/zenodo.19371897} (Zenodo, DOI: 10.5281/zenodo.19371897). The GitHub repository is at \url{https://github.com/LaxmanNandi/MCH-Research}.
