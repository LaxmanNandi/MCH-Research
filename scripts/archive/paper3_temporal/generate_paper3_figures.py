...
POSITION_DATA = TABLES_DIR / "position_drci_data.csv"
TREND_DATA = TABLES_DIR / "position30_trend_comparison.csv"  # Updated path
SUMMARY_DATA = TABLES_DIR / "position_analysis_summary.csv"
TYPE2_DATA = TABLES_DIR / "type2_scaling_validation.csv"  # Use validation data
...
# COMMENTED OUT: Missing position30_trend_comparison.csv data file
# ---------------------------------------------------------------------
...
print("Note: Figure 7 (Kimi K2 scale) skipped - missing trend data")
