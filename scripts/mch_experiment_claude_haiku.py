...
class ExperimentConfig:
    participant_id: str = "claude_haiku_100trials"
    n_trials: int = 100
    ...
    def __post_init__(self):
        if self.models_to_test is None:
            self.models_to_test = ["claude-haiku-4-5-20251001"]
...
class MCHExperiment:
    ...
    def run_experiment(self, prompts: List[str]) -> Dict:
        print("\n" + "="*60)
        print("MCH v8.1 EXPERIMENT - Claude Haiku 4")
        print("="*60)
...
def main():
    ...
    config = ExperimentConfig(
        participant_id="claude_haiku_100trials",
        n_trials=100,
        models_to_test=["claude-haiku-4-5-20251001"],
    ...
    experiment.save_results("mch_results_claude_haiku_100trials.json")

    print("\n" + "="*60)
    print("CLAUDE HAIKU 4.5 EXPERIMENT COMPLETE (100 TRIALS)")
    print("="*60)
