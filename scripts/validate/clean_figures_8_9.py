...
df = pd.read_csv(r'C:\Users\barla\mch_experiments\analysis\trial_level_drci.csv')
...
rerun_path = r'C:\Users\barla\mch_experiments\data\gemini_flash_medical_rerun\mch_results_gemini_flash_medical_50trials.json'
