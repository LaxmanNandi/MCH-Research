...
class ExperimentConfig:
    participant_id: str = "gpt4o_100trials"
    n_trials: int = 100
...
class MCHExperiment:
    def __init__(self, config: ExperimentConfig):
        ...
        self.results = {
            'metadata': {
                ...
                'version': 'MCH_v8.1_GPT4O_100TRIALS'
            },
            'trials': []
        }
    ...
    def run_experiment(self, prompts: List[str]) -> Dict:
        print("\n" + "="*60)
        print("MCH v8.1 EXPERIMENT - GPT-4o (100 Trials)")
        print("="*60)
...
def main():
    ...
    config = ExperimentConfig(
        participant_id="gpt4o_100trials",
        n_trials=100,
    ...
    experiment.save_results("mch_results_gpt4o_100trials.json")

    print("\n" + "="*60)
    print("GPT-4o 100 TRIALS EXPERIMENT COMPLETE")
    print("="*60)
