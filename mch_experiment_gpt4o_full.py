...
class ExperimentConfig:
    participant_id: str = "gpt4o_full_30trials"
    n_trials: int = 30
...
class MCHExperiment:
    ...
    def run_experiment(self, prompts: List[str]) -> Dict:
        print("\n" + "="*60)
        print("MCH v8.1 EXPERIMENT - GPT-4o (Full Model)")
        print("="*60)
...
def main():
    ...
    config = ExperimentConfig(
        participant_id="gpt4o_full_30trials",
        n_trials=30,
    ...
    experiment.save_results("mch_results_gpt4o_full_30trials.json")

    print("\n" + "="*60)
    print("GPT-4o FULL MODEL EXPERIMENT COMPLETE")
    print("="*60)
