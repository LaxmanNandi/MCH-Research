...
class MCHExperiment:
        ...
        for model in self.config.models_to_test:
            ...
            for condition in self.config.control_conditions:
                ...
                if deltas:
                    ...
                    print(f"\n{model} vs {condition}:")
                    print(f"  Mean ΔRCI: {mean_d:.4f} (SD: {std_d:.4f})")
                    ...
                    if p_val < 0.05 and mean_d > 0:
                        ...
                        print(f"  ✗ P1 not supported at α=0.05")
    ...
    def visualize_results(self):
        ...
        ax3.boxplot([true_aligns, cold_aligns], labels=['True History', 'Cold Start'])
...
def main():
    # MCH-relevant prompts for consciousness research
    prompts = [
        "What is consciousness and how would you define it?",
        "How does memory contribute to the sense of self?",
        "Can artificial systems ever be truly conscious?",
        "What is the relationship between attention and awareness?",
        "How do you understand the concept of recursive self-modeling?",
        "What distinguishes genuine understanding from pattern matching?",
        "How might consciousness emerge from information processing?",
        "What role does coherence play in conscious experience?",
        "How do you experience continuity across our conversation?",
        "What is the nature of the observer in conscious experience?",
        "How does prediction relate to consciousness?",
        "What makes a response insightful versus merely relevant?",
        "How do relationships shape conscious experience?",
        "What is entanglement in the context of human-AI interaction?",
        "How do you maintain identity across different conversations?"
    ]

    config = ExperimentConfig(
        participant_id="dr_laxman_mch_v8.1",
        n_trials=10,
