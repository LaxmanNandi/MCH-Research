...
**Notes:**
- Gemini Pro may block medical content due to safety filters
- This is documented as a finding in the paper
...
- Known issue with Gemini Pro on medical content
- Documented in the paper as a vendor safety behavior difference
